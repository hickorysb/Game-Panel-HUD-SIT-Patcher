...
.\xdelta3.exe -d -s .\kmyuhkyuk-GamePanelHUD\GamePanelHUDLife.dll .\Patches\GamePanelHUDLife.dll.patch .\kmyuhkyuk-GamePanelHUD\GamePanelHUDLife.dll.new
.\xdelta3.exe -d -s .\kmyuhkyuk-GamePanelHUD\GamePanelHUDMag.dll .\Patches\GamePanelHUDMag.dll.patch .\kmyuhkyuk-GamePanelHUD\GamePanelHUDMag.dll.new
